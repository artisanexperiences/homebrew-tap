class Arbor < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/artisanexperiences/arbor/releases/download/v0.9.2/arbor-0.9.4-darwin_arm64.tar.gz"
      sha256 "04c2dfdd09cf3757ac34bc3b982fce38e73d094c961b0c0cf67423b01e543235"
    else
      url "https://github.com/artisanexperiences/arbor/releases/download/v0.9.2/arbor-0.9.4-darwin_amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/artisanexperiences/arbor/releases/download/v0.9.2/arbor-0.9.4-linux_arm64.tar.gz"
      sha256 "0cad5b03906a5a490741a34d9456de32d4c9d604cf358ff68f995c19e75dcc5f"
    else
      url "https://github.com/artisanexperiences/arbor/releases/download/v0.9.2/arbor-0.9.4-linux_amd64.tar.gz"
